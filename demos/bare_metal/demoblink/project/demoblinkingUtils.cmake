...
function(define_vendor_and_board vendor board)
    if (${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA6M5.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra6m5" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA4M3.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra4m3" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_FPB_RA2E3.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "fpb_ra2e3" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^RA4M1_CLICKER.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ra4m1_clicker" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA4M1.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra4m1" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA6M3.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra6m3" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA4L1.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra4l1" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_FPB_RA0E2.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "fpb_ra0e2" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA2L2.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra2l2" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_FPB_RA2T1.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "fpb_ra2t1" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA4C1.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra4c1" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_FPB_RA0L1.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "fpb_ra0l1" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA8D1.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra8d1" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_FPB_RA8E1.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "fpb_ra8e1" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA8E2.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra8e2" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA8M1.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra8m1" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_MCB_RA8T1.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "mcb_ra8t1" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_FPB_RA0E1.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "fpb_ra0e1" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA2A1.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra2a1" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA2A2.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra2a2" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_FPB_RA2E1.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "fpb_ra2e1" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_FPB_RA2E2.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "fpb_ra2e2" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA2E1.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra2e1" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA2E2.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra2e2" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA2L1.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra2l1" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_FPB_RA4E1.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "fpb_ra4e1" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA4E2.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra4e2" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA4M2.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra4m2" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_FPB_RA4T1.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "fpb_ra4t1" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_FPB_RA6E1.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "fpb_ra6e1" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA6E2.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra6e2" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA6M4.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra6m4" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA6M1.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra6m1" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA6M2.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra6m2" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_EK_RA4W1.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "ek_ra4w1" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_MOTOR_RSSK_RA6T1.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "rssk_ra6t1" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_MCB_RA6T2.+")
        set(${vendor} "renesas" PARENT_SCOPE)
        set(${board} "mcb_ra6t2" PARENT_SCOPE)
    elseif(${_MSDK_BOARD_NAME_} MATCHES "^BOARD_FPB_RA6T3.+")
        set(${vendor} "renesas" PARENT_SCOPE)
