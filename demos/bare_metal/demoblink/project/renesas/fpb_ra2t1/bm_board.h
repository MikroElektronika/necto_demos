...
static const Pin mikrobus_pins[] = {
    ...
    { R_PORT0, 1 << 13 },   // MIKROBUS_1_RST (A3)
    ...
    { R_PORT5, 1 << 0 },    // MIKROBUS_1_PWM (D6)
    { R_PORT4, 1 << 9 },    // MIKROBUS_1_INT (D2)
    { R_PORT3, 1 << 1 },    // MIKROBUS_1_RX (D0)
    { R_PORT3, 1 << 2 },    // MIKROBUS_1_TX (D1)
    { R_PORT0, 1 << 15 },   // MIKROBUS_1_SCL (A5)
    { R_PORT0, 1 << 14 },   // MIKROBUS_1_SDA (A4)
    { R_PORT0, 1 << 1 },    // MIKROBUS_2_AN (A1)
    { R_PORT0, 1 << 2 },    // MIKROBUS_2_RST (A2)
    ...
    { R_PORT9, 1 << 13 },   // MIKROBUS_2_PWM (D5)
    { R_PORT1, 1 << 11 },   // MIKROBUS_2_INT (D3)
    { R_PORT3, 1 << 1 },    // MIKROBUS_2_RX (D0)
    { R_PORT3, 1 << 2 },    // MIKROBUS_2_TX (D1)
