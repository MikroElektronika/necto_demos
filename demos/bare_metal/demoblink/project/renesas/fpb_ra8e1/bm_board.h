...
static const Pin mikrobus_pins[] = {
    { R_PORT0, 1 << 4 },    // MIKROBUS_1_AN (A0)
    { R_PORT0, 1 << 1 },    // MIKROBUS_1_RST (A3)
    { R_PORT2, 1 << 4 },    // MIKROBUS_1_CS (D10)
    { R_PORT2, 1 << 3 },    // MIKROBUS_1_SCK (D13)
    { R_PORT3, 1 << 13 },   // MIKROBUS_1_CIPO (D12)
    { R_PORT2, 1 << 2 },    // MIKROBUS_1_COPI (D11)
    { R_PORT1, 1 << 13 },   // MIKROBUS_1_PWM (D6)
    { R_PORT3, 1 << 0 },    // MIKROBUS_1_INT (D2)
    { R_PORT3, 1 << 9 },    // MIKROBUS_1_RX (D0)
    { R_PORT3, 1 << 10 },   // MIKROBUS_1_TX (D1)
    { R_PORT0, 1 << 15 },   // MIKROBUS_1_SCL (A5)
    { R_PORT0, 1 << 14 },   // MIKROBUS_1_SDA (A4)
    { R_PORT0, 1 << 3 },    // MIKROBUS_2_AN (A1)
    { R_PORT0, 1 << 7 },    // MIKROBUS_2_RST (A2)
    { R_PORT1, 1 << 12 },   // MIKROBUS_2_CS (D9)
    { R_PORT2, 1 << 3 },    // MIKROBUS_2_SCK (D13)
    { R_PORT3, 1 << 13 },   // MIKROBUS_2_CIPO (D12)
    { R_PORT2, 1 << 2 },    // MIKROBUS_2_COPI (D11)
    { R_PORT1, 1 << 14 },   // MIKROBUS_2_PWM (D5)
    { R_PORT4, 1 << 15 },   // MIKROBUS_2_INT (D3)
    { R_PORT3, 1 << 9 },    // MIKROBUS_2_RX (D0)
    { R_PORT3, 1 << 10 },   // MIKROBUS_2_TX (D1)
    { R_PORT0, 1 << 15 },   // MIKROBUS_2_SCL (A5)
    { R_PORT0, 1 << 14 },   // MIKROBUS_2_SDA (A4)
};
