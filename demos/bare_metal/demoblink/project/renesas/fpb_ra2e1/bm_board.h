...
static const Pin mikrobus_pins[] = {
    ...
    { R_PORT0, 1 << 12 },   // MIKROBUS_1_SDA (A4)
    { R_PORT0, 1 << 1 },    // MIKROBUS_2_AN (A1)
    { R_PORT0, 1 << 2 },    // MIKROBUS_2_RST (A2)
    { R_PORT5, 1 << 1 },    // MIKROBUS_2_CS (D9)
    { R_PORT1, 1 << 2 },    // MIKROBUS_2_SCK (D13)
    { R_PORT1, 1 << 0 },    // MIKROBUS_2_CIPO (D12)
    { R_PORT1, 1 << 1 },    // MIKROBUS_2_COPI (D11)
    { R_PORT3, 1 << 2 },    // MIKROBUS_2_PWM (D5)
    { R_PORT1, 1 << 4 },    // MIKROBUS_2_INT (D3)
    { R_PORT1, 1 << 10 },   // MIKROBUS_2_RX (D0)
    { R_PORT1, 1 << 9 },    // MIKROBUS_2_TX (D1)
    { R_PORT0, 1 << 13 },   // MIKROBUS_2_SCL (A5)
    { R_PORT0, 1 << 12 },   // MIKROBUS_2_SDA (A4)
};
