...
int main(void)
{
    ...
    coordinates[0] = lv_obj_get_y(lv_obj_get_parent(scale1)) + SCALE1_OFFSET;
    coordinates[1] = lv_obj_get_y(lv_obj_get_parent(scale2)) + SCALE2_OFFSET;
    coordinates[2] = lv_obj_get_y(lv_obj_get_parent(scale3)) + SCALE3_OFFSET;
#endif
